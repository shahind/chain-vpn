...
After a reboot, all routings we did in steps 2-19 to 2-21 may be reset. First check them by running `ip route`, you must see a long list of routings, if there are few default routings, you may need to re-do the steps 2-19 to 2-21 again and then connect to server B using `openconnect 2.0.0.0`.
